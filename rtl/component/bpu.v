...
module bpu #(
	...
	parameter BHT_INDEX_BITS = 10,
	parameter BHT_HISTORY_BITS = 2,
	parameter BHT_TABLE_SIZE = 1024
)(
	input clk,
	input rstn,
	input [31:0] if_pc,
	...
	assign if_index = {
		...
		ghr_r ^ if_pc[GHR_BITS+1:2]
	};
	assign ex_index = {
		ex_pc[BHT_INDEX_BITS+1:GHR_BITS+2],
		ghr_r ^ ex_pc[GHR_BITS+1:2]
	};
	...
	always @(posedge clk or negedge rstn) begin
		if (!rstn)
			...
			ghr_r <= {ghr_r[GHR_BITS-2:0], ex_branch_taken};
	end
